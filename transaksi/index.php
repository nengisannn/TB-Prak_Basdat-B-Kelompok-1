...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="tambah.php" class="btn btn-transaksi">
        <i class="fa-solid fa-cart-shopping"></i> Tambah Transaksi
    </a>
</div>
        ...
        <table class="table table-hover align-middle">
            ...
            <?php while($row = mysqli_fetch_assoc($data)){ ?>
                <tr>
                    ...
                    <td>
                        <a href="detail.php?id=<?= $row['id_transaksi']; ?>" class="btn btn-info btn-sm btn-action">
                            <i class="fa fa-eye"></i>
                        </a>
                        <a href="cetak.php?id=<?= $row['id_transaksi']; ?>" target="_blank" class="btn btn-secondary btn-sm btn-action">
